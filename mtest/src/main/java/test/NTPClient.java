...
import com.cpcus.oxygen.components.Network;
...
public final class NTPClient
{
  ...
  public static void main(String[] args)
  {
     ...
     * hostAddr.getHostAddress()); TimeInfo info = client.getTime(hostAddr);
     * processResponse(info); } catch (IOException ioe) { ioe.printStackTrace();
...
//    TimeStamp timestamp = new Network().getNtpRefTime(new String[] { "pool.ntp.org", "us.pool.ntp.org" });
//    System.out.println("------------------------\n" + timestamp + "\n" + timestamp.getTime() + "\n" + timestamp.toUTCString() + "\n" + timestamp.getDate()
//        + "\n" + new Date(timestamp.getTime()) + "\nformated:" + sdf.format(timestamp.getDate()) + "\n"
