...
public class UserServiceLocator extends org.apache.axis.client.Service implements com.nigel.test.UserService {
    ...
    private java.lang.String User_address = "http://localhost/test-axis-ws/services/User";
    ...
    public com.nigel.test.User getUser(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.nigel.test.UserSoapBindingStub _stub = new com.nigel.test.UserSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.nigel.test.User.class.isAssignableFrom(serviceEndpointInterface)) {
                com.nigel.test.UserSoapBindingStub _stub = new com.nigel.test.UserSoapBindingStub(new java.net.URL(User_address), this);
                _stub.setPortName(getUserWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://test.nigel.com", "UserService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://test.nigel.com", "User"));
        }
