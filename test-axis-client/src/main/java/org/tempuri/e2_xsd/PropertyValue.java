...
public class PropertyValue  implements java.io.Serializable {
    ...
    /**
     * Gets the prop value for this PropertyValue.
     * 
     * @return prop
     */
    ...
    /**
     * Sets the prop value for this PropertyValue.
     * 
     * @param prop
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/e2.xsd", "PropertyValue"));
